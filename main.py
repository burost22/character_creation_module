...
"""Import module randint from library random.
It's return value in the specified interval.
"""
...
def special(char_name: str, char_class: str) -> str:
    """Return class's special opportunity value."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Discribes the traning each of classes."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        char_class = input('Назови персонажа, за которого хочешь играть: '
